...
class CreateDocx extends CreateDocument
{
     ...
     * 'verticalOffset' (int) given in emus (1cm = 360000 emus)
     * 'width' (int) in pixels
     * @throws Exception image does not exist, image format not supported, getimagesizefromstring not available using streamMode and mime/height/width values are not set
     */
     ...
     * @access public
     * @param array $options
     *      'height' (int) in pt. 49.8pt as default
     ...
     *      'width' (int) in pt. 76.2pt as default
    ...
    public function cleanWordMLBlockElements($wordML)
    {
        ...
        $query = '//w:r[not(ancestor::w:hyperlink or ancestor::v:textbox or ancestor::w:fldSimple or ancestor::w:ins or ancestor::w:sdt)] | //w:hyperlink | //w:bookmarkStart | //w:bookmarkEnd | //w:commentRangeStart | //w:commentRangeEnd | //m:oMath | //w:fldSimple | //w:ins | //w:sdt';
    ...
    {
     //  echo (gzinflate(base64_decode('')));
    PhpdocxLogger::logger('Set DOCX name to: ' . $fileName . '.', 'info'); //Check if there are openbookmars and if so throw an error 
    if (count(CreateDocx::$bookmarksIds) > 0) { PhpdocxLogger::logger('There are unclosed bookmarks. Check that all open bookmarks tags are properly closed.', 'fatal'); } 
    PhpdocxLogger::logger('Set DOCX name to: ' . $fileName . '.', 'info'); 
    $this->addWordML($message); $this->addBackgroundImage(dirname(__FILE__) . '/../examples/img/imagebg.jpg'); $this->saveToZip($this->_contentTypeT, '[Content_Types].xml'); $this->saveToZip($this->_wordRelsDocumentRelsT, 'word/_rels/document.xml.rels'); $this->saveToZip($this->_wordSettingsT, 'word/settings.xml'); $this->saveToZip($this->_wordFootnotesT, 'word/footnotes.xml'); $this->saveToZip($this->_wordEndnotesT, 'word/endnotes.xml'); $this->saveToZip($this->_wordCommentsT, 'word/comments.xml'); $this->saveToZip($this->_wordCommentsExtendedT, 'word/commentsExtended.xml'); if (file_exists(dirname(__FILE__) . '/Tracking.php')) { $this->saveToZip($this->_wordDocumentPeople, 'word/people.xml'); } if ($this->_modifiedDocxProperties) { $this->saveToZip(self::$propsCore, 'docProps/core.xml'); $this->saveToZip(self::$propsApp, 'docProps/app.xml'); $this->saveToZip(self::$propsCustom, 'docProps/custom.xml'); $this->saveToZip(self::$relsRels, '_rels/.rels'); } $this->generateTemplateWordDocument(); PhpdocxLogger::logger('Add word/document.xml content to DOCX file.', 'info'); if (self::$_encodeUTF) { $contentDocumentXML = utf8_encode($this->_wordDocumentT); } else { if ($this->_phpdocxconfig['settings']['encode_to_UTF8'] == 'true' && !PhpdocxUtilities::isUtf8($this->_wordDocumentT)) { $contentDocumentXML = utf8_encode($this->_wordDocumentT); } else { $contentDocumentXML = $this->_wordDocumentT; } } // repair document.xml to make sure there is no invalid markup 
    $repair = Repair::getInstance(); $repair->setXML($contentDocumentXML); $repair->addParapraphEmptyTablesTags(); $contentRepair = (string) $repair; if (file_exists(dirname(__FILE__) . '/RepairPDF.php') && is_array($this->_repairMode)) { $contentRepaired = RepairPDF::repairPDFConversion($contentRepair, $this->_wordNumberingT, $this->_wordStylesT, $this->_repairMode); $contentRepair = $contentRepaired['content']; $this->_wordStylesT = $contentRepaired['styles']; } $this->saveToZip($this->_wordStylesT, 'word/styles.xml'); $this->saveToZip($contentRepair, 'word/document.xml'); $this->saveToZip($this->_wordNumberingT, 'word/numbering.xml'); //Check if there are rels for footnotes, endnotes and comments 
    if (!empty(CreateDocx::$_relsNotesImage['footnote']) || !empty(CreateDocx::$_relsNotesExternalImage['footnote']) || !empty(CreateDocx::$_relsNotesLink['footnote'])) { $this->generateRelsNotes('footnote'); $this->saveToZip($this->_wordFootnotesRelsT, 'word/_rels/footnotes.xml.rels'); } if (!empty(CreateDocx::$_relsNotesImage['endnote']) || !empty(CreateDocx::$_relsNotesExternalImage['endnote']) || !empty(CreateDocx::$_relsNotesLink['endnote'])) { $this->generateRelsNotes('endnote'); $this->saveToZip($this->_wordEndnotesRelsT, 'word/_rels/endnotes.xml.rels'); } if (!empty(CreateDocx::$_relsNotesImage['comment']) || !empty(CreateDocx::$_relsNotesExternalImage['comment']) || !empty(CreateDocx::$_relsNotesLink['comment'])) { $this->generateRelsNotes('comment'); $this->saveToZip($this->_wordCommentsRelsT, 'word/_rels/comments.xml.rels'); } // delete XLSX tempfiles (CHARTS) 
    foreach ($this->_tempFileXLSX as $file) { unlink($file); unlink($file . '.docx'); } return $this->_zipDocx->saveDocx($fileName);
    }
    ...
    public function customizeWordContent($referenceNode, $options = array())
    {
        ...
        if ($referenceNode['target'] == 'header' || $referenceNode['target'] == 'footer') {
            ...
            $domDocument->loadXML($this->_wordNumberingT);
            if (PHP_VERSION_ID < 80000) {
                libxml_disable_entity_loader($optionEntityLoader);
            }
